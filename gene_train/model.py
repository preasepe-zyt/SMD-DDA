...
class MoleculeModel(nn.Module):
    ...
    def __init__(self, args: TrainArgs):
        ...
        self.Gated = Gated(L=1719, D=1024, dropout=0.3, out=978)  #
        ...
        self.layer_norm = nn.LayerNorm(978)
        #
    ...
    def extra_data_readin(self, args: TrainArgs) -> None:
        train = pd.read_csv('co_network.csv', index_col=0)
...
# sequence encoder 输出
        ...
        mol_f = torch.cat([sequence, atom, bond, h,x], dim=1) #
