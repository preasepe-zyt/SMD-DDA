...
def evaluate(predict, label, is_final=False):
    ...
    result = {"aupr":aupr,
              "auroc":auroc,
              "canning_strategy_aupr":res[0],
              "canning_strategy_auc":res[1],
              "canning_strategy_f1_score":res[2],
              "canning_strategy_accuracy":res[3],
              "canning_strategy_recall":res[4],
              "canning_strategy_specificity":res[5],
              "canning_strategy_precision":res[6]}
    return result