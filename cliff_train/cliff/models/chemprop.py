# code adopted from https://github.com/itakigawa/pyg_chemprop/blob/main/pyg_chemprop.py
import torch
...
class DMPNNEncoder(nn.Module):
    ...
    def forward(self, x, edge_index, edge_attr, batch):
        revedge_index = reverse_edges(edge_index)
        num_nodes = x.shape[0]
        # initialize messages on edges
        init_msg = torch.cat([x[edge_index[0]], edge_attr], dim=1)
